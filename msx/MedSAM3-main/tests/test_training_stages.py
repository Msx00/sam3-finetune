    ...
    for stage in range(1, 6):
        ...
        if stage == 3:
            ...
            required = {
                ...
                "best_metric_name", "best_metric_mode",
...
def test_stage5_decoder_is_opt_in_and_shared_lora_can_be_enabled():
    model, controller, svanet = build_components()
    manager = StageTrainingManager(
        model,
        controller,
        ...
        stage_config={
            ...
            "train_decoder_stage5": True,
        },
    )
    assert manager.trainable_group_names() == {
        "shared_lora",
        "router",
        "auxiliary_head",
        "expert_lora",
