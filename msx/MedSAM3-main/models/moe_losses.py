...
class HierarchicalMoELoss(nn.Module):
    ...
    def forward(
        ...
        native_sam3_loss: Optional[torch.Tensor] = None,
        ...
        components = {
            "native_sam3_loss": (
                native_sam3_loss if native_sam3_loss is not None else zero
            ),
            "sam3_loss": sam3_loss,
            "aux_loss": aux_loss,
            ...
            "refine_loss": zero,
            # Filled after the conditional SvANet branch has produced the
            # differentiably fused full-resolution logits.
            "final_fusion_loss": zero,
        }
        total = zero
